...
import { addCustomer } from "../../functions/customerManagement";
...
export const AddCustomer = () => {
  ...
  const handleAddCustomer = async (data) => {
    const request = await addCustomer(data);
    if (request) {
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <CommonInput
            ...
            className={errors?.website_username?.message ? "border-red-500" : ""}
          />
        ...
        <div className="flex flex-col gap-2">
          ...
          <CommonInput
            ...
            className={errors?.website_password?.message ? "border-red-500" : ""}
          />
