...
// node_modules/react-phone-number-input/modules/react-hook-form/PhoneInputWithCountry.js
var import_react12 = __toESM(require_react(), 1);
var import_prop_types12 = __toESM(require_prop_types(), 1);

// node_modules/react-phone-number-input/modules/react-hook-form/ReactHookFormInput.js
var import_react = __toESM(require_react(), 1);
var import_prop_types = __toESM(require_prop_types(), 1);
var _excluded = ["Component", "name", "defaultValue", "shouldUnregister", "control", "rules", "onChange", "onBlur"];
var _excluded2 = ["ref", "onChange", "onBlur"];
function _extends() {
...
var ReactHookFormInput = function ReactHookFormInput2(_ref, ref) {
  var Component = _ref.Component, name = _ref.name, defaultValue = _ref.defaultValue, shouldUnregister = _ref.shouldUnregister, control = _ref.control, rules = _ref.rules, onChange_ = _ref.onChange, onBlur_ = _ref.onBlur, rest = _objectWithoutProperties(_ref, _excluded);
  ...
  var renderInputComponent = function renderInputComponent2(_ref2) {
    var ref2 = _ref2.ref, onChange2 = _ref2.onChange, onBlur = _ref2.onBlur, restReactHookFormControlledFieldProps = _objectWithoutProperties(_ref2, _excluded2);
    ...
    var setComponentRef = (0, import_react.useCallback)(function(instance) {
      setRef(instance);
    }, [ref2, setRef]);
    var onChangeCombined = (0, import_react.useCallback)(function(value) {
      if (value === void 0) {
        value = null;
      }
      onChange2(value);
    ...
    var onBlurCombined = (0, import_react.useCallback)(function(event) {
      onBlur(event);
      if (onBlur_) {
        onBlur_(event);
      }
    }, [onBlur, onBlur_]);
    return import_react.default.createElement(Component, _extends({}, rest, restReactHookFormControlledFieldProps, {
      ref: setComponentRef,
  ...
  return import_react.default.createElement(Controller, {
    control,
    name,
    defaultValue,
    shouldUnregister,
...
ReactHookFormInput = import_react.default.forwardRef(ReactHookFormInput);
ReactHookFormInput.propTypes = {
  ...
  shouldUnregister: import_prop_types.default.bool,
  // A developer should pass a `control` object that is returned from `useForm()` hook.
  // Not required when using `<FormProvider/>`.
  control: import_prop_types.default.object,
  rules: import_prop_types.default.object,
  onChange: import_prop_types.default.func,
  onBlur: import_prop_types.default.func
};
var ReactHookFormInput_default = ReactHookFormInput;
...
var metadata = import_prop_types2.default.shape({
  country_calling_codes: import_prop_types2.default.object.isRequired,
  countries: import_prop_types2.default.object.isRequired
});
var labels = import_prop_types2.default.objectOf(import_prop_types2.default.string);
...
// node_modules/input-format/modules/react/Input.js
var _excluded3 = ["value", "parse", "format", "inputComponent", "onChange", "onKeyDown"];
function _extends2() {
...
function Input(_ref, ref) {
  var value = _ref.value, parse2 = _ref.parse, format3 = _ref.format, InputComponent = _ref.inputComponent, onChange2 = _ref.onChange, onKeyDown2 = _ref.onKeyDown, rest = _objectWithoutProperties2(_ref, _excluded3);
  ...
  return import_react2.default.createElement(InputComponent, _extends2({}, rest, {
    ref: setRef,
...
Input.propTypes = {
  ...
  parse: import_prop_types3.default.func.isRequired,
  // Formats `value` into `<input/>` text.
  format: import_prop_types3.default.func.isRequired,
  ...
  onCut: import_prop_types3.default.func,
  onPaste: import_prop_types3.default.func
};
Input.defaultProps = {
  // Renders `<input/>` by default.
...
// node_modules/react-phone-number-input/modules/InputSmart.js
var _excluded4 = ["country", "international", "withCountryCallingCode", "metadata"];
function _extends3() {
...
function createInput(defaultMetadata) {
  function InputSmart(_ref, ref) {
    var country = _ref.country, international = _ref.international, withCountryCallingCode = _ref.withCountryCallingCode, _ref$metadata = _ref.metadata, metadata2 = _ref$metadata === void 0 ? defaultMetadata : _ref$metadata, rest = _objectWithoutProperties3(_ref, _excluded4);
    ...
    return import_react3.default.createElement(Input_default, _extends3({}, rest, {
      ref,
  ...
  InputSmart.propTypes = {
     ...
     */
    country: import_prop_types4.default.string,
    /**
     ...
     */
    international: import_prop_types4.default.bool,
    /**
     ...
     */
    withCountryCallingCode: import_prop_types4.default.bool,
    /**
     * `libphonenumber-js` metadata.
     */
    metadata: import_prop_types4.default.object
  };
  return InputSmart;
}
...
var _excluded5 = ["value", "onChange", "country", "international", "withCountryCallingCode", "metadata", "inputComponent"];
function _extends4() {
...
function createInput2(defaultMetadata) {
  function InputBasic(_ref, ref) {
    var value = _ref.value, onChange2 = _ref.onChange, country = _ref.country, international = _ref.international, withCountryCallingCode = _ref.withCountryCallingCode, _ref$metadata = _ref.metadata, metadata2 = _ref$metadata === void 0 ? defaultMetadata : _ref$metadata, _ref$inputComponent = _ref.inputComponent, Input2 = _ref$inputComponent === void 0 ? "input" : _ref$inputComponent, rest = _objectWithoutProperties4(_ref, _excluded5);
    var prefix = getInputValuePrefix({
      country,
      international,
      withCountryCallingCode,
    ...
    return import_react5.default.createElement(Input2, _extends4({}, rest, {
      ref,
  ...
  InputBasic.propTypes = {
     ...
     * because if `value` is an international number then `country` is ignored.
     */
    country: import_prop_types5.default.string,
    /**
     * If `country` property is passed along with `international={true}` property
     * then the phone number will be input in "international" format for that `country`
     * (without "country calling code").
     ...
     * (without "country calling code" `+1`).
     */
    international: import_prop_types5.default.bool,
    /**
     * If `country` and `international` properties are set,
     * then by default it won't include "country calling code" in the input field.
     * To change that, pass `withCountryCallingCode` property,
     * and it will include "country calling code" in the input field.
     */
    withCountryCallingCode: import_prop_types5.default.bool,
    /**
     * `libphonenumber-js` metadata.
     */
    metadata: import_prop_types5.default.object,
    /**
     * The `<input/>` component.
     */
...
// node_modules/react-phone-number-input/modules/CountrySelect.js
var _excluded6 = ["value", "onChange", "options"];
...
function CountrySelect(_ref) {
  var value = _ref.value, onChange2 = _ref.onChange, options = _ref.options, rest = _objectWithoutProperties5(_ref, _excluded6);
  ...
  return import_react6.default.createElement("select", _extends5({}, rest, {
    value: value || "ZZ",
    onChange: onChange_
...
CountrySelect.propTypes = {
  ...
  // `<select/>` options.
  options: import_prop_types6.default.arrayOf(import_prop_types6.default.shape({
    value: import_prop_types6.default.string,
...
function CountrySelectWithIcon(_ref3) {
  ...
  }, import_react6.default.createElement(CountrySelect, _extends5({}, rest, {
    value,
    options,
...
CountrySelectWithIcon.propTypes = {
  ...
  arrowComponent: import_prop_types6.default.elementType,
  // Set to `true` to render Unicode flag icons instead of SVG images.
  unicodeFlags: import_prop_types6.default.bool
};
...
function FlagComponent(_ref) {
  var country = _ref.country, countryName = _ref.countryName, flags = _ref.flags, flagUrl = _ref.flagUrl, rest = _objectWithoutProperties6(_ref, _excluded7);
  if (flags && flags[country]) {
    return flags[country]({
      title: countryName
    });
  }
  return import_react7.default.createElement("img", _extends6({}, rest, {
    alt: countryName,
...
FlagComponent.propTypes = {
  ...
  country: import_prop_types7.default.string.isRequired,
  // Will be HTML `title` attribute of the `<img/>`.
  countryName: import_prop_types7.default.string.isRequired,
  ...
  flags: import_prop_types7.default.objectOf(import_prop_types7.default.elementType),
  // A URL for a country flag icon.
  // By default it points to `country-flag-icons` gitlab pages website.
  flagUrl: import_prop_types7.default.string.isRequired
};
...
function InternationalIcon(_ref) {
  var aspectRatio = _ref.aspectRatio, rest = _objectWithoutProperties7(_ref, _excluded8);
  if (aspectRatio === 1) {
...
InternationalIcon.propTypes = {
  ...
  aspectRatio: import_prop_types8.default.number
};
function InternationalIcon3x2(_ref2) {
  var title = _ref2.title, rest = _objectWithoutProperties7(_ref2, _excluded23);
  return import_react8.default.createElement("svg", _extends7({}, rest, {
...
function createCountryIconComponent(_ref) {
  ...
  function CountryIcon(_ref2) {
    var country = _ref2.country, label = _ref2.label, aspectRatio = _ref2.aspectRatio, rest = _objectWithoutProperties8(_ref2, _excluded9);
    var _aspectRatio = InternationalIcon2 === InternationalIcon ? aspectRatio : void 0;
    return import_react9.default.createElement("div", _extends8({}, rest, {
  ...
  CountryIcon.propTypes = {
    country: import_prop_types9.default.string,
    label: import_prop_types9.default.string.isRequired,
    aspectRatio: import_prop_types9.default.number
  };
  return CountryIcon;
}
...
var PhoneNumberInput_ = function(_React$PureComponent) {
  ...
  _createClass(PhoneNumberInput_2, [{
    ...
    value: function render() {
      ...
      return import_react10.default.createElement(ContainerComponent, {
        style,
      ...
      }, import_react10.default.createElement(CountrySelectComponent, _extends9({
      ...
      })), import_react10.default.createElement(InputComponent, _extends9({
...
var PhoneNumberInput = import_react10.default.forwardRef(function(props, ref) {
  return import_react10.default.createElement(PhoneNumberInput_, _extends9({}, withDefaultProps(props), {
    inputRef: ref
  }));
});
PhoneNumberInput.propTypes = {
  ...
  initialValueFormat: import_prop_types10.default.oneOf(["national"]),
  // `displayInitialValueAsLocalNumber` property has been
  // superceded by `initialValueFormat` property.
  displayInitialValueAsLocalNumber: import_prop_types10.default.bool,
  /**
   * The country to be selected by default.
   ...
   * `["RU", "UA", "KZ"]`
   */
  countries: import_prop_types10.default.arrayOf(import_prop_types10.default.string),
  /**
   ...
   */
  locales: import_prop_types10.default.oneOfType([import_prop_types10.default.string, import_prop_types10.default.arrayOf(import_prop_types10.default.string)]),
  /*
   ...
   */
  flagUrl: import_prop_types10.default.string,
  /**
   ...
   */
  flags: import_prop_types10.default.objectOf(import_prop_types10.default.elementType),
  /**
   ...
   */
  flagComponent: import_prop_types10.default.elementType,
  /**
   * Set to `false` to remove the "International" option from country `<select/>`.
   */
  addInternationalOption: import_prop_types10.default.bool,
  /**
   ...
   */
  internationalIcon: import_prop_types10.default.elementType,
  /**
   ...
   * `["US", "CA", "AU", "|", "..."]`
   */
  countryOptionsOrder: import_prop_types10.default.arrayOf(import_prop_types10.default.string),
  /**
   ...
   */
  countrySelectComponent: import_prop_types10.default.elementType,
  /**
   * Country `<select/>` component props.
   * Along with the usual DOM properties such as `aria-label` and `tabIndex`,
   * some custom properties are supported, such as `arrowComponent` and `unicodeFlags`.
   */
  countrySelectProps: import_prop_types10.default.object,
  /**
   ...
   */
  numberInputProps: import_prop_types10.default.object,
  /**
   ...
   */
  // Is `true` by default.
  smartCaret: import_prop_types10.default.bool,
  /**
   ...
   */
  limitMaxLength: import_prop_types10.default.bool,
  /**
   * If set to `false`, and `international` is `true`, then
   * users won't be able to erase the "country calling part"
   * of a phone number in the `<input/>`.
   */
  countryCallingCodeEditable: import_prop_types10.default.bool,
  /**
   * `libphonenumber-js` metadata.
   *
  ...
  onCountryChange: import_prop_types10.default.func,
  /**
   ...
   */
  focusInputOnCountrySelection: import_prop_types10.default.bool
};
var defaultProps = {
  /**
  ...
  reset: import_prop_types10.default.any,
  /**
   *
   */
  /**
...
function createPhoneInput(defaultMetadata) {
  var PhoneInputDefault = import_react11.default.forwardRef(function(_ref, ref) {
    var _ref$metadata = _ref.metadata, metadata2 = _ref$metadata === void 0 ? defaultMetadata : _ref$metadata, _ref$labels = _ref.labels, labels2 = _ref$labels === void 0 ? en_json_default : _ref$labels, rest = _objectWithoutProperties10(_ref, _excluded11);
    return import_react11.default.createElement(PhoneInputWithCountry_default, _extends10({}, rest, {
      ref,
      metadata: metadata2,
      labels: labels2
    }));
...
function createPhoneInput2(defaultMetadata) {
  var PhoneInputWithCountry = function PhoneInputWithCountry2(_ref, ref) {
    var _ref$metadata = _ref.metadata, metadata2 = _ref$metadata === void 0 ? defaultMetadata : _ref$metadata, rest = _objectWithoutProperties11(_ref, _excluded12);
    return import_react12.default.createElement(ReactHookFormInput_default, _extends11({}, rest, {
      ref,
      metadata: metadata2,
      Component: PhoneInputWithCountryDefault_default
    }));
  };
  PhoneInputWithCountry = import_react12.default.forwardRef(PhoneInputWithCountry);
  PhoneInputWithCountry.propTypes = {
    metadata
  };
  return PhoneInputWithCountry;
}
var PhoneInputWithCountry_default2 = createPhoneInput2();

// node_modules/react-phone-number-input/react-hook-form/index.js
var react_hook_form_default = createPhoneInput2(metadata_min_json_default);
export {
  react_hook_form_default as default
};
...
classnames/index.js:
  ...
  *)
*/
//# sourceMappingURL=react-phone-number-input_react-hook-form.js.map
